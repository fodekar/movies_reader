...
<head>
    ...
    <!--[if lt IE 9]>
        <script src="http://razonartificial.com/themes/reason/v1.6/assets/js/html5shiv.min.js"></script>
        <script src="http://razonartificial.com/themes/reason/v1.6/assets/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<!-- Scripts -->
<!-- Compiled in vendors.js -->
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/vendors.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/styleswitcher.js"></script>
<!-- Syntaxhighlighter -->
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shCore.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shBrushXml.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shBrushJScript.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/DropdownHover.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/app.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/holder.js"></script>
<script src="http://razonartificial.com/themes/reason/v1.6/assets/js/home_info.js"></script>
</body>
