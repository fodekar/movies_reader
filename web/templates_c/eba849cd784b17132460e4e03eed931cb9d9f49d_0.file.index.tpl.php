<?php
/* Smarty version 3.1.34-dev-7, created on 2019-09-12 11:41:19
  from 'C:\Users\Fodekar\Documents\workspace\movies_reader\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d7a2edfb8ddf8_78159708',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'eba849cd784b17132460e4e03eed931cb9d9f49d' => 
    array (
      0 => 'C:\\Users\\Fodekar\\Documents\\workspace\\movies_reader\\templates\\index.tpl',
      1 => 1568282764,
      2 => 'file',
    ),
  ),
...
function content_5d7a2edfb8ddf8_78159708 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- CSS -->
    <link href="http://razonartificial.com/themes/reason/v1.6/assets/css/preload.css" rel="stylesheet">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <!-- Compiled in vendors.js -->
    <link href="http://razonartificial.com/themes/reason/v1.6/assets/css/vendors.css" rel="stylesheet">
    <link href="http://razonartificial.com/themes/reason/v1.6/assets/css/syntaxhighlighter/shCore.css" rel="stylesheet" >
    <link href="http://razonartificial.com/themes/reason/v1.6/assets/css/style-blue.css" rel="stylesheet" title="default">
    <link href="http://razonartificial.com/themes/reason/v1.6/assets/css/width-full.css" rel="stylesheet" title="default">

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
        <?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/html5shiv.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/respond.min.js"><?php echo '</script'; ?>
>
    <![endif]-->
</head>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-md-push-6">
                            <div class="">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/mockup2.png" alt="" class="img-responsive animated zoomInUp animation-delay-30">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-push-6">
                            <div class="carousel-object">
                                ...
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wire1.png" class="img-responsive base animated animated-slow reveal animation-delay-25" alt="Image">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wire1.png" class="img-responsive relative animated animated-slow reveal animation-delay-25" alt="Image">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wire1shadow.png" class="img-responsive relative animated fadeIn animation-delay-40" alt="Image">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wire1capture.png" class="img-responsive relative animated fadeIn animation-delay-45" alt="Image">
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-md-pull-6">
            ...
            <div class="item">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-md-push-6">
                            <div class="">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/mockup3.png" alt="" class="img-responsive animated zoomInRight animation-delay-30">
                            </div>
                        </div>
                        <div class="col-md-6 col-md-pull-6">
                            <div class="carousel-caption">
        ...
        <div class="tab-content margin-top">
            <div class="tab-pane" id="windows">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-7 col-md-pull-6 col-lg-pull-5">
                        <img class="img-responsive animated zoomInDown animation-delay-3" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/surface.jpg">
                    </div>
                </div>
            </div>
            <div class="tab-pane active" id="mac">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-7">
                        <img class="img-responsive animated zoomInDown animation-delay-3" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/new_mac.jpg">
                    </div>
                </div>
            </div>
            <div class="tab-pane" id="linux">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-7 col-md-pull-6 col-lg-pull-5">
                        <img class="img-responsive animated zoomInDown animation-delay-3" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/ubuntu_tablet.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w1.jpg" class="img-responsive" alt="Image">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w2.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Image title</h4>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w3.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Image title</h4>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w4.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Image title</h4>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w5.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Image title</h4>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="img-caption-ar wow fadeInUp">
                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/w6.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Image title</h4>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="panel panel-default panel-card wow fadeInRight animation-delay-2">
                <div class="panel-heading">
                    <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/card1.jpg" />
                ...
                <div class="panel-thumbnails">
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="thumbnail">
                                <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/img60.jpg" />
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="thumbnail">
        ...
        <div class="col-sm-6 col-md-3">
            <div class="panel panel-default panel-card wow fadeInRight animation-delay-4">
                <div class="panel-heading">
                    <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/card2.jpg" />
                    <button class="btn btn-primary btn-ar btn-sm" role="button">Follow</button>
                </div>
                <div class="panel-figure">
        ...
        <div class="col-sm-6 col-md-3">
            <div class="panel panel-default panel-card wow fadeInRight animation-delay-6">
                <div class="panel-heading">
                    <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/card3.jpg" />
                    <button class="btn btn-primary btn-ar btn-sm" role="button">Follow</button>
                </div>
                <div class="panel-figure">
        ...
        <div class="col-sm-6 col-md-3">
            <div class="panel panel-default panel-card wow fadeInRight animation-delay-8">
                <div class="panel-heading">
                    <img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/card4.jpg" />
                    <button class="btn btn-primary btn-ar btn-sm" role="button">Follow</button>
                </div>
                <div class="panel-figure">
    ...
    <section class="margin-top">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/intel.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/microsoft.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/nokia.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/samsung.png" alt="" class="img-responsive"></div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/anz.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/maxis.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/sony.png" alt="" class="img-responsive"></div>
                    <div class="col-md-3 col-sm-3 col-xs-6"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/hp.png" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="footer-widget">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/m2.jpg" width="75" height="75" alt="image"></a>
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/m11.jpg" width="75" height="75" alt="image"></a>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/m4.jpg" width="75" height="75" alt="image"></a>
                        <div class="media-body">
                ...
                <div class="footer-widget">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wf1.jpg" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wf2.jpg" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wf3.jpg" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="http://razonartificial.com/themes/reason/v1.6/assets/img/demo/wf4.jpg" class="img-responsive" alt="Image"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Compiled in vendors.js -->
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/vendors.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/styleswitcher.js"><?php echo '</script'; ?>
>
<!-- Syntaxhighlighter -->
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shCore.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shBrushXml.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/syntaxhighlighter/shBrushJScript.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/DropdownHover.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/app.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/holder.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="http://razonartificial.com/themes/reason/v1.6/assets/js/home_info.js"><?php echo '</script'; ?>
>
</body>
